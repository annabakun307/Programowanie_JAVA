...
public class Account {
    ...
    private static char ukrAlphabet[] = {'а', 'б', 'в', 'г', 'д', 'е', 'є', 'ж', 'з', 'и', 'і', 'ї',
            'й', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ь', 'ю', 'я'};
    private static String translitRep[] = {"а", "b", "v", "g", "d", "e", "je", "zh", "z", "y", "i", "ji",
            "j", "k", "l", "m", "n", "о", "p", "r", "s", "t", "u", "f", "h", "c", "ch", "sh", "shh", "*", "ju", "ja"};
